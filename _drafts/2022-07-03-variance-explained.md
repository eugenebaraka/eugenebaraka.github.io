...
published: true
tags: [variance, statistics, population, sample]
header-img: assets/posts/variance_explained/meme_variance.png
description: |
...
![Distribution of sepal length](/assets/posts/variance_explained/output.png)
...
![Square of the distance](/assets/posts/variance_explained/diff_square.png)
...
![image](/assets/posts/variance_explained/squared_diff.png)

In this case, the variance is close to 0.7, which is the same as the one calculated using numpy.

![variance](/assets/posts/variance_explained/variance.png)
...
![sample variance](/assets/posts/variance_explained/sample_var.png)
...
![test function](/assets/posts/variance_explained/test_fun.png)

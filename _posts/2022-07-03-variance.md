...
date: 2022-07-03
description: Why do we square the deviations from the mean in the variance formula? What is the difference between population and sample variance? Read on to easily make sense of this important statistical measure!
featured_image: 'images/variance.png'
---

<span class="firstcharacter">I</span>n my data science learning journey, I set a goal to really understand the fundamental topics before moving on to advanced ones. Instead of striving to learn as many things as I can, I slow down and really understand how things work under the hood. This is because I believe that "you can't fix what you don't understand" and understanding is totally different from knowing. This weekend, I revisited my statistics basics and thought of writing about an easy way to understand variance. 
...
![variance](/images/posts/variance_explained/var.png)
...
![libraries](/images/posts/variance_explained/libraries.png)

Loading and visualizing the first 7 rows of the data


![first 7 rows](/images/posts/variance_explained/head.png)
...
![Distribution of sepal length](/images/posts/variance_explained/output.png)
...
![Square of the distance](/images/posts/variance_explained/diff_square.png)
...
![image](/images/posts/variance_explained/squared_diff.png)

In this case, the variance is close to 0.7, which is the same as the one calculated using numpy.

![variance](/images/posts/variance_explained/variance.png)
...
![sample variance](/images/posts/variance_explained/sample_var.png)
...
![variance function](/images/posts/variance_explained/var_fun.png)

Testing it out...

![test function](/images/posts/variance_explained/test_fun.png)
